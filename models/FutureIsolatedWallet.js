...
const FutureIsolatedSchema = new mongoose.Schema({
...
FutureIsolatedSchema.plugin(uniqueValidator);

module.exports = mongoose.model("FutureIsolated", FutureIsolatedSchema);
